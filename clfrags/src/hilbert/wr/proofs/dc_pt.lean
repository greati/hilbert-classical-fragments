        ...
        namespace wr
            namespace dc_pt
                ...
                theorem dcpt₇_dc {a b c d e f g h i : Prop} (h₁ : dc h i (pt f g (dc a b (pt c d e)))) : 
                    ...
                    have h₂ : pt (dc h i f) (dc h i g) (dc h i (dc a b (pt c d e))), from dcpt₁ h₁,
                    have h₃ : pt (dc h i f) (dc h i g) (dc (dc h i a) (dc h i b) (pt c d e)), from dc₆'_pt h₂,
                    have h₄ : pt (dc h i f) (dc h i g) (pt (dc (dc h i a) (dc h i b) c) (dc (dc h i a) (dc h i b) d) (dc (dc h i a) (dc h i b) e)), 
                        from dcpt₇ h₃,
                    have h₅ : pt (pt (dc h i f) (dc h i g) (dc (dc h i a) (dc h i b) c)) (dc (dc h i a) (dc h i b) d) (dc (dc h i a) (dc h i b) e), 
                        from pt.pt₆ h₄,
                    have h₆ : pt (pt (dc h i f) (dc h i g) (dc (dc h i a) (dc h i b) c)) (dc (dc h i a) (dc h i b) d) (dc h i (dc a b e)), 
                        from dc₇'_pt h₅,
                    have h₇ : pt (pt (dc h i f) (dc h i g) (dc (dc h i a) (dc h i b) c)) (dc h i (dc a b e)) (dc (dc h i a) (dc h i b) d), 
                        from pt.pt₃ h₆,
                    have h₈ : pt (pt (dc h i f) (dc h i g) (dc (dc h i a) (dc h i b) c)) (dc h i (dc a b e)) (dc h i (dc a b d)), 
                        from dc₇'_pt h₇,
                    have h₉ : pt (dc h i f) (dc h i g) (pt (dc (dc h i a) (dc h i b) c) (dc h i (dc a b e)) (dc h i (dc a b d))), 
                        from pt.pt₇ h₈,
                    have h₁₀ : pt (dc h i f) (dc h i g) (pt (dc h i (dc a b e)) (dc h i (dc a b d)) (dc (dc h i a) (dc h i b) c)), 
                        from pt.pt₃_ast (pt.pt₂_ast h₉),
                    have h₁₁ : pt (pt (dc h i f) (dc h i g) (dc h i (dc a b e))) (dc h i (dc a b d)) (dc (dc h i a) (dc h i b) c), 
                        from pt.pt₆ h₁₀,
                    have h₁₂ : pt (pt (dc h i f) (dc h i g) (dc h i (dc a b e))) (dc h i (dc a b d)) (dc h i (dc a b c)), 
                        from dc₇'_pt h₁₁,
                    have h₁₃ : pt (dc h i f) (dc h i g) (pt (dc h i (dc a b e)) (dc h i (dc a b d)) (dc h i (dc a b c))), 
                        from pt.pt₇ h₁₂,
