        ...
        namespace wr
            namespace ad
                ...
                theorem ad₂_ad {a b c d e : Prop} (h₁ : ad a d e) : ad (ad (ad c a b) a c) d e := 
                    have h₂ : (ad a d e) → (((ad c a c) or (ad c a b)) or ((ad c d e) or (ad c a b))),
                        from (assume h, ad₂₀ (ad₁₃ (ad₂₀ (ad₁₀ (ad₈ (ad₁₃ (ad₆' h))))))),
                    have h₃ : ((ad c a c) or (ad c a b)) → ((ad (ad c a b) d e) or (ad (ad c a b) a c)),
                        from (assume h, ad₁₃ (ad₆' (ad₁₁ h))),
                    have h₄ : ((ad c d e) or (ad c a b)) → ((ad (ad c a b) d e) or (ad (ad c a b) a c)), 
                        from (assume h, ad₆' (ad₁₁ h)),
                    have h₅ : (((ad c a c) or (ad c a b)) or ((ad c d e) or (ad c a b))) → 
                        ((ad (ad c a b) d e) or (ad (ad c a b) a c)), 
                        from δ_or₁ h₃ h₄,
                    have h₆ : ad a d e → ((ad (ad c a b) d e) or (ad (ad c a b) a c)), from T₁ h₂ h₅,
                    show ad (ad (ad c a b) a c) d e, from ad₁₁ (h₆ h₁)
                ...
                theorem ad₃_ad {a b c d e f g h : Prop} (h₁ : ad (ad a b c) g h) :
                    ...
                    let j := ad (ad f a d) a (ad e a d), k := ad (ad f a e) a d, i := ad j a k in
                        have h₂ : (ad (ad a b c) g h) → ((ad a g h) or (ad a b c)), from ad₁₀,
                ...
                theorem ad₄_ad {a b c d e f g : Prop} (h₁ : ad (ad a b c) f g) :
                    ...
                    let h := ad d a (ad d a (ad e a d)) in
                        have h₂ : (ad (ad a b c) f g) → ((ad a f g) or (ad a b c)), from ad₁₀,
                ...
                theorem ad₇_ad {a b c d e f : Prop} (h₁ : ad (ad (ad c d c) a b) e f) : 
                    ad (ad (ad c a b) (ad d a b) (ad c a b)) e f := 
                ...
                theorem ad₁₂_ad {a b c: Prop} (h₁ : ad (ad a a a) b c) : ad a b c := 
                    ad₁₂ (ad₇ h₁)

                theorem ad₁₃_ad {a b c d : Prop} (h₁ : ad (ad a b a) c d) : ad (ad b a b) c d :=
                    ad₈ (ad₁₃ (ad₇ h₁))

                theorem ad₁₄_ad {a b c d e : Prop} (h₁ : ad (ad a (ad b c b) a) d e) : ad (ad (ad a b a) c (ad a b a)) d e :=
                ...
                theorem ad₈_ad {a b c d e f : Prop} (h₁ : ad (ad (ad c a b) (ad d a b) (ad c a b)) e f) : 
                    ad (ad (ad c d c) a b) e f := 
                ...
                theorem ad₉_ad {a b c d e f g : Prop} (h₁ : ad (ad a b c) f g) (h₂ : ad (ad d e a) f g) : ad (ad d b c) f g :=
                    have h₃ : ad (ad a b c) f g → ((ad a f g) or (ad a b c)), from ad₁₀,
                    have h₄ : ad (ad d e a) f g → ((ad d f g) or (ad d e a)), from ad₁₀,
                    have h₅ : ad a b c → ad d f g → ((ad d f g) or (ad d b c)), from M₂ ad₆',
                    have h₆ : ad a b c → ad d e a → ((ad d f g) or (ad d b c)), 
                        from (assume h, assume i, ad₁₃ (ad₆' (ad₉ h i))),
                    have h₇ : ad a f g → ad d f g → ((ad d f g) or (ad d b c)), from M₂ ad₆',
                    have h₈ : ad a f g → ad d e a → ((ad d f g) or (ad d b c)), 
                        from (assume h, assume i, ad₆' (ad₉ h i)),
                    have h₉ : ((ad d f g) or (ad d e a)) → ad a b c → ((ad d f g) or (ad d b c)),
                        from flip (δ_or₂ h₅ h₆),
                    have h₁₀ : ((ad d f g) or (ad d e a)) → ad a f g  → ((ad d f g) or (ad d b c)),
                        from flip (δ_or₂ h₇ h₈),
                    have h₁₁ : ((ad d f g) or (ad d e a)) → ((ad a f g) or (ad a b c)) → ((ad d f g) or (ad d b c)),
                        from δ_or₂ h₁₀ h₉,
                    have h₁₂ : (ad (ad a b c) f g) → ((ad d f g) or (ad d e a)) → ((ad d f g) or (ad d b c)),
                        from flip (T₂ (M₂ h₃) h₁₁),
                    have h₁₃ : (ad (ad a b c) f g) → (ad (ad d e a) f g) → ((ad d f g) or (ad d b c)),
                        from T₂ (M₂ h₄) h₁₂,
                    ad₁₁ (h₁₃ h₁ h₂)

                theorem ad₁₀_ad {a b c d e f g : Prop} (h₁ : ad (ad (ad e d c) a b) f g) 
                    : ad ((ad e a b) or (ad e d c)) f g :=
                    have h₂ : ad (ad (ad e d c) a b) f g → ((ad (ad e d c) f g) or (ad (ad e d c) a b)), from ad₁₀,
                ...
                theorem ad₁₁_ad {a b c d e f g : Prop} (h₁ : ad ((ad e a b) or (ad e d c)) f g) 
                    ...
                    have h₃ : ad (ad e a b) f g → ((ad e f g) or (ad e a b)),
                        from ad₁₀,
                    have h₄ : ad e f g → ((ad e f g) or (ad e d c)), from ad₆',
                    ...
                    have h₇ : ((ad e a b) or (ad e d c)) → ad (ad (ad e d c) a b) f g,
                        from (assume h, ad₆ (ad₁₁ h)),
                    have h₈ : ad e a b → ((ad e a b) or (ad e d c)), from ad₆',
